...
import { MdFilterList, MdOutlineShowChart, MdSearch, MdClose, MdOutlinePeople } from 'react-icons/md';
            ...
            <div className="flex items-center gap-1">
              <div className="flex items-center gap-1">
                <div className="flex flex-col items-end">
                  <span className="text-xs text-gray-400">{user?.email_user || 'correo@correo.com'}</span>
                </div>
                <div 
